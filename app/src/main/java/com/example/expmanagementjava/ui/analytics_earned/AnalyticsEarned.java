...
import com.example.expmanagementjava.ui.analytics.AnalyticsViewModel;
...
public class AnalyticsEarned extends Fragment {

    private AnalyticsEarnedViewModel analyticsEarnedViewModel;
    private PieChart pieChart;

    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        analyticsEarnedViewModel = new ViewModelProvider(this).get(AnalyticsEarnedViewModel.class);
    ...
    // Function to setup the Income PieChart
    private void setupPieChart(){
        pieChart.setDrawHoleEnabled(true);
        pieChart.setUsePercentValues(false);
        pieChart.setEntryLabelTextSize(12);
        pieChart.setEntryLabelColor(Color.BLACK);
        pieChart.setCenterText("MONEY EARNED");
        pieChart.setCenterTextSize(24);
        pieChart.getDescription().setEnabled(false);
    }

    // Function to load the Income PieChart
